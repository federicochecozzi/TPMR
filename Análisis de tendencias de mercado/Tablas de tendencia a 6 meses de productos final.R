...
table_internet <- df_internet %>% 
  ...
  gt::tab_options(
    ...
    table.width = gt::px(180)
  )

table_internet

gt::gtsave(table_internet,"Tendencia producto internet.png")
...
gt::gtsave(table_reseller,"Tendencia producto reventa.png", vwidth = 675, vheight = 2000)
